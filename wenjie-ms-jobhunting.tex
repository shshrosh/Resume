...
%\setcounter{enumi}{10}
%\item {\bf Wenjie Hu}, ``Cross-layer Design in Wireless Mesh Networks'', {\em First Aisa-FI (Future Internet)}, 2008.
%\end{enumerate}
...
%\begin{enumerate} [leftmargin=7mm]%\itemsep -1pt % Reduce space between items
%\setcounter{enumi}{13}
%\item {\bf Wenjie Hu} and Guohong Cao, ``Quality-Aware Traffic Offloading in Wireless Networks'', {\em submitted to IEEE Journal on Selected Areas in Communications}.
%\item {\bf Wenjie Hu} and Guohong Cao, ``Energy-Aware CPU Frequency Scaling for Mobile Video Streaming'', {\em submitted to IEEE INFOCOM} 2016.
%%\item Yibo Wu, Yi Wang, {\bf Wenjie Hu}, Xiaomei Zhang and Guohong Cao, ``Resource-Aware Photo Crowdsourcing Through Delay Tolerant Networks'', {\em submitted to IEEE INFOCOM} 2016.
%\item {\bf Wenjie Hu} and Guohong Cao, ``Characterizing the Energy Consumption of Wireless Interfaces on Smartphones'', {\em submitted to IEEE Communications Magazine}.
%\end{enumerate}
...
%\begin{enumerate} [leftmargin=7mm]%\itemsep -1pt % Reduce space between items
%\setcounter{enumi}{16}
%\item {\bf Wenjie Hu} and Chiu Ngo, ``LTE-assisted MAC Protocol to Reduce Delay for Vehicle to Vehicle Communications'', approval pending.
%\end{enumerate}
%
